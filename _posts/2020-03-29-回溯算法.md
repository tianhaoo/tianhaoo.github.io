...
class Solution {
    public List<List<Integer>> subsets(int[] nums) {
        ...
        backtrack(res, route, nums, selected, 0);
        return res;
    }

    public void backtrack(List<List<Integer>> res, List<Integer> route, int[] nums, boolean[] selected, int start){
        ...
        for(int i=start; i<nums.length; i++){  // 所有可能的选择
            ...
            if(!selected[i]){
                ...
                backtrack(res, route, nums, selected, i+1);
